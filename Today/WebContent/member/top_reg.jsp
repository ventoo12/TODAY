...
.bgimg {
	...
	background-image:
		url("https://modo-phinf.pstatic.net/20200118_252/1579337837602ny3sa_JPEG/mosayq1SWA.jpeg?type=w556");
	min-height: 60%;
}
		...
		<div class="w3-row w3-padding w3-black">
			...
			<div class="w3-col s3">
				<a data-toggle="modal" href="#myModal"
					class="w3-button w3-block w3-black">누르면 터짐</a>
			</div>
			<div class="w3-col s3">
				<a href="about.do" class="w3-button w3-block w3-black">TODAY 소개</a>
			</div>
			<div class="w3-col s3">
				<a href="javascript:alert('문의 사절')"
					class="w3-button w3-block w3-black">문의</a>
			</div>
		</div>
	</div>
		...
		<div class="w3-container" id="about">
			<div class="w3-content" style="max-width: 900px">
				<h3 class="w3-center w3-padding-64">
					<span class="w3-tag w3-wide">TODAY 회원 가입</span>
				</h3>