...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar">
    ...
    <div class="w3-card w3-round w3-white">
      <div class="w3-container">
       <h4 class="w3-center" style="padding-top:20px">${loginUser.nick_name}${loginUser.userid}</h4>
  ...
  <div class="w3-bar-block">
    <a href="#portfolio" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>내 게시판</a> 
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <button class="w3-button w3-white"><i class="fa fa-diamond w3-margin-right"></i>게시글 올리기</button>
