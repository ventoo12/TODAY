...
$(function(){
	...
	<h1 align="center">소모임 정보 수정</h1>
            <form class="form-horizontal" role="form"  id="mf"  name="mf" action="meetingUpdateEnd.do" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <img src="images/${meeting.image}" class="img img-responsive" style="width:340px;height:340px">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="date" class="form-control" id="mdate" name="mdate" placeholder="">
                </div>
                <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="password" class="form-control" id="mpwd" name="mpwd" required>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-4">
                  <button type="button" class="btn btn-default" onclick="location.href='meetingList.do'">목록으로</button>
